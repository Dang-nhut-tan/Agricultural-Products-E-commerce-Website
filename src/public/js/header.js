...
if (oldHeader) {
  oldHeader.innerHTML = `<div class="container modern-header"><a class="modern-logo" href="/" aria-label="Nông Sản Xanh - Trang chủ"><span class="modern-logo-mark" aria-hidden="true">🌱</span><span><b>NÔNG SẢN XANH</b><small>TƯƠI LÀNH MỖI NGÀY</small></span></a><form class="modern-search" id="modernSearch" role="search"><label class="sr-only" for="modernSearchInput">Tìm món ăn hoặc sản phẩm</label><input id="modernSearchInput" type="search" placeholder="Bạn muốn nấu món gì? Ví dụ: lẩu bò"><button type="submit" aria-label="Tìm kiếm"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="11" cy="11" r="6.5"/><path d="m16 16 4 4"/></svg></button></form><nav class="modern-nav" id="primaryNav" aria-label="Điều hướng chính"><a href="/" class="${location.pathname === "/" ? "active" : ""}" ${location.pathname === "/" ? 'aria-current="page"' : ""}>Trang chủ</a><a href="/san-pham" class="${location.pathname.startsWith("/san-pham") ? "active" : ""}">Sản phẩm</a><a href="/tin-tuc" class="${location.pathname === "/tin-tuc" ? "active" : ""}">Tin tức</a><a class="sale" href="/#products">Khuyến mãi</a></nav><button type="button" class="modern-cart" id="modernCart" aria-label="Mở giỏ hàng, ${state.cart.reduce((n, x) => n + x.qty, 0)} sản phẩm"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 4h2l2 11h10l3-7H6"/><circle cx="9" cy="19" r="1.5"/><circle cx="17" cy="19" r="1.5"/></svg><i aria-hidden="true">${state.cart.reduce((n, x) => n + x.qty, 0)}</i></button><a class="modern-account" href="/dang-nhap" aria-label="Đăng nhập"><span aria-hidden="true">N</span><b>Đăng nhập</b></a><button type="button" class="mobile-menu" id="mobileMenu" aria-label="Mở menu" aria-controls="primaryNav" aria-expanded="false">☰</button></div>`;
  document.querySelector(".modern-logo-mark")?.replaceWith(Object.assign(document.createElement("img"), {
    className: "modern-logo-mark",
    src: "/images/brand/nong-san-xanh-mark.png",
    alt: "",
  }));
